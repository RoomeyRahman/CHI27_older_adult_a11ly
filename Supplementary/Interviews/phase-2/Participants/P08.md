...
**Interviewer:** Apa, I just have a few more questions. You said the voice reminder is the most useful part for you. So, compared with a normal phone alarm that only rings, what is better about this smart reminder?

**Respondent:** Hmm, normal alarm only makes a sound. This one can tell me it is medicine time, maybe say which one, and show the picture also. That is easier for me.

**Interviewer:** So it should explain what the reminder is for, not just ring?

**Respondent:** Yes yes. If it says in Bangla, medicine time, and shows the packet, then I understand. I don't need to read too much.

**Interviewer:** And if you are busy talking or doing some work and you don't respond the first time?

**Respondent:** Then it can remind me one more time. That is okay. But not many times. Too much sound will irritate me.

**Interviewer:** And after that?

**Respondent:** If I still don't answer, then tell my son. He can call and ask me.

**Interviewer:** What if you already took the medicine but forgot to press the button?

**Respondent:** That can happen. So it should not immediately say I missed it. My son can ask first. Maybe I took it already.

**Interviewer:** Now, how do you think this system can make things easier for both you and your son?

**Respondent:** For me, it helps me remember the time and which medicine. For my son, he doesn't have to tell me every time. He can know only if I really miss something or medicine is finishing.

**Interviewer:** Would you want him to receive a message every time you take a medicine?

**Respondent:** No no. No need. If everything is okay, let me take it myself. Only if there is some problem.

**Interviewer:** What kind of problem should make the system contact him?

**Respondent:** If I don't respond for a long time, if I miss medicine, or if the medicine is almost finished. Those are useful things.

**Interviewer:** Do you think this system can solve all your medicine problems?

**Respondent:** No, not all. It can help me remember. But knowing the medicine name, reading the prescription, or when medicine changes, I still need my son.

**Interviewer:** What problems would still remain?

**Respondent:** New medicine, difficult prescription, different packet, things like that. I don't know all the names. My son has to check.

**Interviewer:** If the system says one thing and your son says something different, what would you do?

**Respondent:** I will ask my son what the doctor said. If needed, he can call the doctor. I will not guess.

**Interviewer:** Is there anything the system should never do by itself?

**Respondent:** Yes. It should not tell me to change medicine, stop medicine, or take something new by itself. Doctor decides that.

**Interviewer:** So what should the actual role of the system be for you?

**Respondent:** Simple. Remind me, say the medicine time in Bangla, show the medicine picture, maybe morning or night picture, and that's enough.

**Interviewer:** And what should your son still do?

**Respondent:** He should set everything up, put the medicine name and time, keep the prescription, and change it if doctor changes something. He can also bring the medicine when it is finishing.

**Interviewer:** Would you want to type or change those settings yourself?

**Respondent:** No no. I cannot do all that. My son should do it. I just want to hear the reminder and take the medicine.

**Interviewer:** Should the system replace your son's help?

**Respondent:** No. It should make his work easier, not replace him. He knows me and the medicine. The phone only helps with remembering.

**Interviewer:** And what should the doctor still do?

**Respondent:** Doctor should decide what medicine I take. The phone can only remind me what the doctor already gave.

**Interviewer:** If you had to describe the main role of this system in one simple sentence, what would you say?

**Respondent:** Tell me the right medicine at the right time, and tell my son only when there is a real problem.

**Interviewer:** Anything else you would change?

**Respondent:** Clear Bangla voice, big writing, medicine picture, and not too many buttons. That is enough for me.

**Interviewer:** Okay, apa. Thank you very much.
