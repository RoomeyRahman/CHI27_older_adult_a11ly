...
2. **Quotes verbatim.** Participant quotations are untouchable: no rewording, no trimming without ellipsis already present in the source, no new quotes, and no gloss added after one. Caregivers stay quoted by ID only, and no name, employer, or workplace may be introduced or left standing (CLAUDE.md Section 3.4).
