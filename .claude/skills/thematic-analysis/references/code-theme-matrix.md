...
(SKILL.md Section 0.0), `A1/` for Claude Code and `A2/` and beyond for other analysing agents:
...
```bash
python3 .claude/skills/thematic-analysis/scripts/table_check.py . <slot>
```
