...
`/output/codes/`, `A1/` for Claude Code and `A2/` and beyond for other analysing agents (SKILL.md Section 0.0). It sits at the top of the
...
CLAUDE.md Section 3 and their filed sources; single-analyst rationale; translation from Bangla;
...
(CLAUDE.md Section 6.2) and boundary conditions.
