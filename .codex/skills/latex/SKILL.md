...
8. **Participant names.** A real participant name may not enter the LaTeX. If the markdown carries a name that has not been confirmed as a pseudonym (AGENTS.md Section 3.2), stop and report it rather than transcribing it.
...
```bash
python3 .codex/skills/latex/scripts/md2tex.py output/Methodology.md \
