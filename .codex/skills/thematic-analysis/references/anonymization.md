...
**Names in AGENTS.md.** AGENTS.md Section 3.2 lists participant names appearing in the current Study 2
...
question once in the run report, and do not propagate a name on the grounds that AGENTS.md already contains it.
...
Consent in a collectivist household is familial as well as individual (AGENTS.md Section 9.4). Check each
