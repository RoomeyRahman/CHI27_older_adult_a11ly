...
3. **Retain and park.** Park, in order of confidence: instrument codes that only ever answer a direct question;
   ...
   AGENTS.md Section 9.3 are protected here specifically. At master level, check participant balance: if the
...
```
<!-- slot: A2 | unit: study1/OA03 | pass: A complete | B complete | C pending -->
```
